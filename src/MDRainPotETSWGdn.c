...
int MDRainPotETSWGdnDef () {
	...
	MFDefEntering ("Rainfed Potential Evapotranspiration (Shuttleworth - Wallace [day-night])",__FILE__);
	...
	MFDefLeaving  ("Rainfed Potential Evapotranspiration (Shuttleworth - Wallace [day-night])",__FILE__);
	return (_MDOutPetID);
}
