...
int MDRainPotETPMdnDef () {
	...
	MFDefEntering ("Rainfed Potential Evapotranspiration (Penman - Montieth [day-night])",__FILE__);
	...
	MFDefLeaving  ("Rainfed Potential Evapotranspiration (Penman - Montieth [day-night])",__FILE__);
	return(_MDOutPetID);
}
